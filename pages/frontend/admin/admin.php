...
if (!isset($_SESSION['user_info']) || $_SESSION['user_info']['vai_tro'] !== 'admin') {
...
<body>
    <div class="dashboard-container">
        ...
        <div class="main-content">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="status-badge 
                                                <?php echo $user['vai_tro'] == 'admin' ? 'status-active' : 
                                                      ($user['vai_tro'] == 'nha_san_xuat' ? 'status-pending' : 'status-inactive'); ?>">
            ...
            <?php if($current_section != 'dashboard' && $current_section != 'users'): ?>
            <div class="content-section">
                <div class="section-header">
    ...
    <script>
        ...
        function initializeCharts() {
            ...
            const rolesChart = new Chart(rolesCtx, {
                type: 'doughnut',
                data: {
                    labels: <?php echo json_encode(array_column($users_by_role, 'vai_tro')); ?>,
                    datasets: [{
        ...
        // Các hàm xử lý MetaMask và tab (giữ nguyên từ code trước)
